    ...
    <div className="min-h-screen flex flex-col relative bg-transparent">
      <nav className="fixed top-0 left-0 w-full z-50 glass border-b border-white/5 px-6 py-5">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <Link
            to="/"
            className="text-2xl font-black font-heading tracking-tighter flex items-center gap-2"
          >
            <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
              NOVEXIS
            </span>
            <span className="text-[10px] font-bold text-white/30 tracking-[0.4em] mt-1 uppercase">
              Studios
            </span>
          </Link>
          ...
          <div className="hidden md:flex items-center space-x-12">
            ...
            {user?.role === "admin" ? (
              <div className="flex items-center gap-6 ml-4 pl-8 border-l border-white/10">
                <Link
                  to="/admin"
                  className="text-[12px] font-bold text-purple-400 hover:text-white uppercase tracking-[0.1em] flex items-center gap-2"
                >
              ...
              <Link
                to="/login"
                className="text-[13px] font-medium text-white/40 hover:text-white/80 tracking-[0.1em] uppercase px-6 py-2 border border-white/10 rounded-full transition-all hover:bg-white/5"
              >
                Portal
              </Link>
            )}
